...
async def upload_file(
    ...
    vs_path, loaded_files, _ = local_doc_qa.init_knowledge_vector_store([file_path], vs_path)
...
async def upload_files(
    ...
    if filelist:
        vs_path, loaded_files, _ = local_doc_qa.init_knowledge_vector_store(filelist, get_vs_path(knowledge_base_id))
        if len(loaded_files):
